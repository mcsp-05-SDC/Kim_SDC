...
COPY item(name, image, price, prodid, size, material, features, cleaning shipop, shipdet, shipret, qna, description)
FROM 'C:\Users\jsick\sfltap\Item-detail\db\details.csv'
DELIMITER ','
CSV HEADER;
